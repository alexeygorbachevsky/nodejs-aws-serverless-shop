...
WITH product as (
    ...
    ('Things Fall Apart', 300, 'It is the ideal postcolonial novel.'),
    ...
    ('The Handmaids Tale', 300, 'Despite the passage of time, I have not forgotten how prescient The Handmaids Tale was, and how prescient it felt.'),
...
((select product.id from product where product.title = 'The Handmaids Tale'), 2),
